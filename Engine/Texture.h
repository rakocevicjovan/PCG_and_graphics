...
public:
	...
	std::string fileName;	//helpful to debug loaders with but otherwise meh... 
	...
	inline const unsigned char* const getData() const { return data; }	//ptr or data can't be modified, only read
