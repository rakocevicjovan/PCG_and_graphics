...
bool ShaderCM::SetShaderParameters(ID3D11DeviceContext* deviceContext, Model& model, const SMatrix& v, const SMatrix& p,
	...
	dataPtr2->pos = dLight.dir;	//actually direction but uses the same struct for convenience
